...
import { accentureCertData, badgesData, alibabaCertData } from "../../data/portfolioData";
...
const Portfolio = () => {
  ...
  const AccentureCert = accentureCertData;
  ...
  const Certifications = [
    ...
    ...alibabaCertData.map((c) => ({
      ...c,
      category: isItalian ? "Certificazioni" : "Certifications",
    })),
  ];
